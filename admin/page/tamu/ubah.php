                    ...
                    <div class="col-md-12">
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumlah_tamu" value="<?php echo $data['jumlah_tamu'] ?>"
                                       class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="temu" class="form-control" id="nama" data-toggle="modal"
                                       data-target="#modal-default" value="<?php echo $data['ketemu'] ?>" readonly="">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Jam :</label>
                                <input type="time" name="jam" class="form-control" id="nama" readonly=""
                        ...
                        <div class="modal fade" id="modal-default">
                            ...
                            if (isset($_POST['simpan'])) {
                                ...
                                $koneksi->query("UPDATE  tb_tamu SET  nama='$nama', alamat='$alamat', jumlah_tamu='$jumlah_tamu', telp='$telp', jk='$jk', keperluan='$perlu', tanggal='$tgl', jam='$jam', ketemu='$temu'  where id_tamu='$id'");
