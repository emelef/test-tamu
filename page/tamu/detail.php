        ...
        <div class="col-md-9">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img src="upload/<?php echo $data['foto'] ?>" width="750" height="400"
                         style="text-align: center; margin-left: px; ">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>Tanggal</b> <a
                                    class="pull-right"><?php echo date('d F Y', strtotime($data['tanggal'])) ?></a>
